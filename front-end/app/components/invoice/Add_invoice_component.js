      ...
      <h1 className="center heading">Add Invoice</h1>
        <div className="well well-lg ">
          <form onSubmit={handleSubmit(this.handleState)} className="form-inline">
            <span >
              <Field name="Invoice_Number"  type="text" id="invoice_number" onChange={this.handleFields} component={renderField} label="Invoice Number : " placeholder="Invoice Number" />
              <Field name="Invoicer_Name"  type="text" value="ashvin" id="invoicer_name" onChange={this.handleFields} component={renderField} label="Invoicer Name : " placeholder="Invoicer Name" />
            </span>
            <br></br>
            <span>
              <Field name="Date"  type="date" id="invoice_date" component={renderField} onChange={this.handleFields} label="Date :" placeholder="Invoice Date" />
              <Field name="Invoicer_Contact" id="invoicer_contact" type="text" component={renderField} onChange={this.handleFields} label="Invoicer Contact : " placeholder="Invoicer Contact" />
            </span>
            <br></br>
            <br></br>
            <span>
              <Field name="Description"  component={rendreTextArea} label="Description : " id="invoice_description" onChange={this.handleFields} placeholder="Description" />
              <Field name="Invoicer_Aaddress" component={rendreTextArea} id="invoicer_address" onChange={this.handleFields} label="Invoicer Address : " placeholder="Invoicer Address" />
            </span>
            <br/>
